...
.markdown-body h1 {\r
  ...
  font-size: 2em;\r
  border-bottom: 1px solid #3d444db3;\r
}\r
\r
.markdown-body mark {\r
  background-color: #bb800926;\r
  color: #f0f6fc;\r
}\r
\r
...
.markdown-body kbd {\r
  ...
  background-color: #151b23;\r
  border: solid 1px #3d444db3;\r
  border-bottom-color: #3d444db3;\r
  border-radius: 6px;\r
  box-shadow: inset 0 -1px 0 #3d444db3;\r
}\r
\r
.markdown-body h1,\r
.markdown-body h2,\r
...
.markdown-body blockquote {\r
  ...
  padding: 0 1em;\r
  color: #9198a1;\r
  border-left: .25em solid #3d444d;\r
}\r
\r
.markdown-body ul,\r
.markdown-body ol {\r
...
.markdown-body table tr {\r
  background-color: #0d1117;\r
  border-top: 1px solid #3d444db3;\r
}\r
\r
...
.markdown-body .pl-ii {\r
  color: #f0f6fc;\r
  background-color: #8e1519;\r
}\r
\r
.markdown-body .pl-c2 {\r
  color: #f0f6fc;\r
  background-color: #b62324;\r
}\r
\r
.markdown-body .pl-sr .pl-cce {\r
  font-weight: bold;\r
...
.markdown-body .pl-md {\r
  color: #ffdcd7;\r
  background-color: #67060c;\r
}\r
\r
.markdown-body .pl-mi1 {\r
  color: #aff5b4;\r
  background-color: #033a16;\r
}\r
\r
.markdown-body .pl-mc {\r
  color: #ffdfb6;\r
  background-color: #5a1e02;\r
}\r
\r
.markdown-body .pl-mi2 {\r
  color: #f0f6fc;\r
  background-color: #1158c7;\r
}\r
\r
